...
import edu.ccny.googlefit.SensorListener;
import edu.ccny.googlefit.util.GoogleFit;
import edu.ccny.googlefit.util.Logger;
import edu.ccny.googlefit.util.PlayServices;
